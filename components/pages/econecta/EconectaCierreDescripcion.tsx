...
export function EconectaCierreDescripcion({ data }: { data?: any }) {
  ...
  const paragraphHtml = data?.description || `Descubre <strong class="text-[#4ADE80] font-extrabold">ECONECTA</strong>, la solución integral de conectividad sostenible impulsada por el sol. Esta torre inteligente no solo provee Wi-Fi, sino que integra seguridad, servicios ciudadanos y una potente gestión de datos. Nuestro objetivo es claro: facilitar el acceso a la tecnología para democratizar la inclusión digital y conectar a todos, en todas partes.`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <FadeContent delay={0.1} duration={0.6}>
          <div className="max-w-4xl mx-auto space-y-6 text-justify">
            <p 
              className="text-base sm:text-lg lg:text-xl text-slate-200 font-sans leading-relaxed text-justify whitespace-pre-wrap"
