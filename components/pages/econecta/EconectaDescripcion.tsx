...
export function EconectaDescripcion() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeContent delay={0.1} duration={0.6}>
          <div className="max-w-4xl mx-auto space-y-6 text-justify">
            <p className="text-base sm:text-lg lg:text-xl text-slate-700 font-sans leading-relaxed text-justify">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-slate-700 font-sans leading-relaxed text-justify">
              Nuestro enfoque integra diferentes disciplinas de ingeniería en una única plataforma tecnológica.
            </p>
          </div>
        </FadeContent>
      </div>
