...
import { Timeline } from "@/components/pages/nosotros/Timeline";
import { SectorFocus } from "@/components/pages/nosotros/SectorFocus";
import { CertificationsGrid } from "@/components/pages/nosotros/CertificationsGrid";
        ...
        <FadeContent delay={0.1} duration={0.8}>
          <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-[#00D4FF]/30 bg-[#00D4FF]/10 text-[#00D4FF] font-mono text-xs mb-6 uppercase shadow-[0_0_15px_rgba(0,212,255,0.15)]">
              ...
              <span>// SOBRE NOSOTROS // IDENTIDAD CORPORATIVA</span>
            </div>
            ...
            <p className="mt-6 text-base sm:text-lg text-zinc-400 font-mono max-w-2xl mx-auto leading-relaxed">
              En SPRECTRUMP COLOMBIA lideramos la transformación digital y energética con infraestructura de alta disponibilidad en telecomunicaciones y energía solar fotovoltaica para el sector empresarial y gubernamental.
            </p>
          </div>
        </FadeContent>
      </section>
