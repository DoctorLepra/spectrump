...
```bash
echo "FIRECRAWL_API_KEY=fc-d4ba1435aeda4a5f8efbfebb70191a35" >> .env
```
...
**Auth header:** `Authorization: Bearer fc-d4ba1435aeda4a5f8efbfebb70191a35`
...
API key configured for this environment:

```dotenv
FIRECRAWL_API_KEY=fc-d4ba1435aeda4a5f8efbfebb70191a35
```
